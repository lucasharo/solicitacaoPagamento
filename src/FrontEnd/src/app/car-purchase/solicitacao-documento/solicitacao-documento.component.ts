...
@Component({
  selector: 'app-solicitacao-documento',
  templateUrl: './solicitacao-documento.component.html',
  styleUrls: ['./solicitacao-documento.component.css'],
  providers: [Modal]
})
export class SolicitacaoDocumentoComponent extends CommonComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.hot = new Handsontable(container, {
      ...
      columns: [
        ...
        { title: 'IPVA', data: 'ipva', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 150 },
        { title: 'DPVAT', data: 'dpvat', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 100 },
        { title: 'Licenciamento', data: 'licenciamento', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 100 },
        { title: 'Despachante', data: 'despachante', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 150 },
  ...
  ajustaItens(solicitacaoPagamento: any, itens: any[]) {
    ...
    itens.forEach((item) => {
      solicitacaoPagamento.solicitacao_Pagamento_Detalhe.push({
        ...
        ipva: item.ipva ? item.ipva : 0,
        dpvat: item.dpvat ? item.dpvat : 0,
        licenciamento: item.licenciamento ? item.licenciamento : 0,
        despachante: item.despachante ? item.despachante : 0,
