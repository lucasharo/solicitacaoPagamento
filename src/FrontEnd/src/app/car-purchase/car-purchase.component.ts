...
export class CarPurchaseComponent extends CommonComponent implements OnInit, AfterViewInit {
  ...
  submitBuscarSolicitacoesPagamento() {
    this.data.busy = this.CarPurchaseService.apiCarPurchaseGetSolicitacoesPagamentoGet()
      .subscribe((data) => {
        this.rerender(0);
