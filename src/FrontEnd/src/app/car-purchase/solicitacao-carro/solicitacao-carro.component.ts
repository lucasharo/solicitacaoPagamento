...
@Component({
  selector: 'app-solicitacao-carro',
  templateUrl: './solicitacao-carro.component.html',
  styleUrls: ['./solicitacao-carro.component.css'],
  providers: [Modal]
})
export class SolicitacaoCarroComponent extends CommonComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.hot = new Handsontable(container, {
      ...
      columns: [
        ...
        { title: 'Valor do Veículo', data: 'valor', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 150 },
        { title: 'Opcionais', data: 'opcionais_veiculo', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 100 },
        { title: 'Acessórios', data: 'acessorios_veiculo', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 100 },
        { title: 'Outros Serviços', data: 'outros_servicos', type: 'numeric', numericFormat: { pattern: 'R$0,00', culture: 'pt-BR' }, allowEmpty: true, width: 150 },
  ...
  ajustaItens(solicitacaoPagamento: any, itens: any[]) {
    ...
    itens.forEach((item) => {
      solicitacaoPagamento.solicitacao_Pagamento_Detalhe.push({
        ...
        opcionais_veiculo: item.opcionais_veiculo ? item.opcionais_veiculo : 0,
        acessorios_veiculo: item.acessorios_veiculo ? item.acessorios_veiculo : 0,
        outros_servicos: item.outros_servicos ? item.outros_servicos : 0,
        reused_flag_sn: item.reused_flag_sn,
