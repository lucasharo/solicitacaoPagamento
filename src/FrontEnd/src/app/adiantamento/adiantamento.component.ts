...
export class AdiantamentoComponent extends CommonComponent implements OnInit, AfterViewInit {
  ...
  submitBuscarSolicitacoesPagamento() {
    this.data.busy = this.AdiantamentoService.apiAdiantamentoGetSolicitacoesPagamentoGet()
      .subscribe((data) => {
        this.rerender(0);
