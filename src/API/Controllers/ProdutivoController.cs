...
{
    public class ProdutivoController : GenericController<Solicitacao_Pagamento>
    {
        private ProdutivoNegocio negocio;

        public ProdutivoController(ProdutivoNegocio negocio) : base(negocio)
        {
        ...
        public Resposta GetSolicitacoesPagamento() => this.negocio.GetSolicitacoesPagamentoByDiretoria(Enums.TipoSolicitacaoPagamento.Produtivo);

        [HttpGet("GetSolicitacoesPagamentoDashboard")]
        public Resposta GetSolicitacoesPagamentoDashboard() => this.negocio.GetSolicitacoesPagamentoDashboard(Enums.TipoSolicitacaoPagamento.Produtivo);
