...
{
    public class NaoProdutivoController : GenericController<Solicitacao_Pagamento>
    {
        private NaoProdutivoNegocio negocio;

        public NaoProdutivoController(NaoProdutivoNegocio negocio):base(negocio)
        {
        ...
        public Resposta GetSolicitacoesPagamento() => this.negocio.GetSolicitacoesPagamentoByDiretoria(Enums.TipoSolicitacaoPagamento.NaoProdutivo);

        [HttpGet("GetSolicitacoesPagamentoDashboard")]
        public Resposta GetSolicitacoesPagamentoDashboard() => this.negocio.GetSolicitacoesPagamentoDashboard(Enums.TipoSolicitacaoPagamento.NaoProdutivo);
